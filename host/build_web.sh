...
EXPORTS='_host_boot,_host_boot_incubation,_host_feed_princess,_host_warp,_host_pr_maturity,_host_pr_bond,_host_pr_hunger,_host_pr_dormant,_host_pr_hatched,_host_pr_px,_host_pr_py,_host_pr_boredom,_host_pr_social,_host_pr_rest,_host_founded_unix,_host_seed,_host_catchup,_host_set_now,_host_set_clock,_host_set_weather,_host_step,_host_fb,_host_w,_host_h,_host_tap,_host_boop,_host_gather,_host_gather_end,_host_selected,_host_conkers,_host_snapshot,_host_snapshot_ptr,_host_events_ptr,_host_events_len,_host_events_clear,_host_grant_wish,_host_feed_colony,_host_care_package,_host_rename,_host_set_tint,_host_tint_conker,_host_set_colony_title,_host_buy_decor,_host_bugs,_host_water,_host_bond_peak_new,_host_move_decor,_host_decor_at,_host_flowering,_host_interact_ready,_host_shop_json,_host_owned,_host_unequip,_host_worn,_host_throw_ball,_host_pr_ball,_host_pr_ball_x,_host_pr_ball_y,_host_pr_critter_x,_host_pr_critter_y,_host_room_x,_host_room_y,_host_room_w,_host_room_h,_host_pr_state,_host_pr_sleeping,_host_pr_foodpiles,_host_export_princess,_host_export_princess_ptr,_host_stage_summon,_host_set_verdant,_malloc,_free'
