...
export async function sendCommand(
  colonyId: string,
  type: 'name_conker' | 'feed_colony' | 'set_module_role' | 'set_floor_tint' | 'tint_conker' | 'set_colony_title' | 'buy_decor' | 'gift_care_package' | 'ota_update' | 'set_followed' | 'grant_wish' | 'summon_queen',
