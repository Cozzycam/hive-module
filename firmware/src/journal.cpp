...
static const char* CRITTER_NAMES[] = {
    "beetle", "butterfly", "worm", "firefly",
    "moth", "snail", "ladybird", "dragonfly",
};
...
void EventJournal::_serialize_entry(const JournalEntry& e, char* buf, size_t buflen) {
    ...
    case JEVT_DISCOVERY:
        ...
        break;
    case JEVT_WISH_GRANTED:
        data["kind"] = (e.wish.kind == 1) ? "treat" : "boop";
        break;
    case JEVT_CRAFTED:
    case JEVT_ART_WEATHERED:
        data["kind"] = (e.crafted.kind < 7) ? ART_KIND_NAMES[e.crafted.kind] : "work";
